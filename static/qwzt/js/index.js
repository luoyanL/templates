$(document).ready(function() {
        ...
        setTimeout(function() { a() }, 100), $(window).resize(function() { a() })
    }),
    function(a, b) { "use strict"; "function" == typeof define && "object" == typeof define.amd ? define([], function() { return b(a) }) : a.SineWaves = b(a) }(this, function() {
        ...
        function b(a, b) { return i.isType(a, "number") ? a : (a = a.toString(), a.indexOf("%") > -1 ? (a = parseFloat(a), a > 1 && (a /= 100), b * a) : a.indexOf("px") > -1 ? parseInt(a, 10) : void 0) }
        ...
        var a = new SineWaves({
                ...
                speed: 12,
                width: function() { var a = $(document).width(); return 768 > a ? 3 * $("#waves").parent().width() : 1.4 * $("#waves").parent().width() },
                height: function() { return $("#waves").parent().height() },
                wavesWidth: "200%",
                ease: "SineInOut",
                waves: [{ timeModifier: .5, lineWidth: 2, amplitude: 45, wavelength: 100, segmentLength: 1 }, { timeModifier: .5, lineWidth: 2, amplitude: 30, wavelength: 75, segmentLength: 1 }, { timeModifier: .5, lineWidth: 2, amplitude: 15, wavelength: 40, segmentLength: 1 }],
                initialize: function() {},
                resizeEvent: function() {
                    var a = this.ctx.createLinearGradient(0, 0, this.width, 0);
                    a.addColorStop(0, "rgba(231,241,253, 0.5)"), a.addColorStop(.5, "rgba(231,241,253, 1)"), a.addColorStop(1, "rgba(231,241,253, 0)");
            ...
            f = b.offset().top;
        (c > e || f > d) && (a.running = !1, a.update()), $(window).bind("scroll", function() { c = $(document).scrollTop(), d = $(document).scrollTop() + $(window).height(), e = b.offset().top + b.height(), f = b.offset().top, c > e || f > d ? (a.running = !1, a.update()) : (a.running = !0, a.update()) })
    }), $(function() {
        var a = new SineWaves({
                ...
                wavesWidth: "100%",
                ease: "SineInOut",
                waves: [{ timeModifier: .5, lineWidth: 2, amplitude: 160, wavelength: 150, segmentLength: 1 }, { timeModifier: .6, lineWidth: 2, amplitude: 100, wavelength: 100, segmentLength: 1 }],
                initialize: function() {},
                resizeEvent: function() {
                    var a = this.ctx.createLinearGradient(0, 0, this.width, 0);
        ...
        var a = new SineWaves({
                ...
                speed: 8,
                width: function() { var a = $(document).width(); return 768 > a ? 3 * $("#waves2").parent().width() : 1.4 * $("#waves2").parent().width() },
                height: function() { return $("#waves2").parent().height() },
                wavesWidth: "100%",
                ease: "SineInOut",
                waves: [{ timeModifier: .5, lineWidth: 2, amplitude: 100, wavelength: 150, segmentLength: 1 }, { timeModifier: .5, lineWidth: 2, amplitude: 50, wavelength: 80, segmentLength: 1 }],
                initialize: function() {},
                resizeEvent: function() {
                    var a = this.ctx.createLinearGradient(0, 0, this.width, 0);
                    a.addColorStop(0, "rgba(255, 255, 255, 0)"), a.addColorStop(.5, "rgba(255, 255, 255, 0.2)"), a.addColorStop(1, "rgba(255, 255, 255, 0)");
