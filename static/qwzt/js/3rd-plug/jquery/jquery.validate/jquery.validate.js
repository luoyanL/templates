...
$.extend($.fn, {
	...
	rules: function(command, argument) {
		...
		//begin add by caochuncheng 2009-06-22 
		//make sure dDependence is at front
		if (data.dDependence) {
			var param = data.dDependence;
			delete data.dDependence;
			data = $.extend({dDependence: param}, data);
		}
		//end add by caochuncheng 2009-06-22
		return data;
	},
	// destructive add
	push: function( t ) {
